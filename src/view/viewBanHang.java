...
public class viewBanHang extends javax.swing.JInternalFrame {
    ...
    private void tblHoaDonMoiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHoaDonMoiMouseClicked
        ...
        this.fillGioHang(rphd.getGioHang(tblHoaDonMoi.getValueAt(i, 1).toString()));
    ...
    private void tblSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPhamMouseClicked
        ...
        int slNew = -1;
        try {
            x = Integer.parseInt(JOptionPane.showInputDialog("Vui lòng nhập số lượng").toString());
    ...
    private void txtTienKhachDuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtTienKhachDuaActionPerformed
        ...
        int tien = 0;
        try {
            tien = Integer.parseInt(txtTienKhachDua.getText().trim());
            if (tien < giaCuoi) {
